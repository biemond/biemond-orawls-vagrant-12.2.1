...
module Puppet
  Type.newtype(:wls_virtual_target) do
    ...
    on_create do | command_builder |
      ...
      template('puppet:///modules/orawls/providers/wls_virtual_target/create.py.erb', binding)
    end

    on_modify do | command_builder |
      Puppet.info "modify #{name} "
      template('puppet:///modules/orawls/providers/wls_virtual_target/modify.py.erb', binding)
    end
